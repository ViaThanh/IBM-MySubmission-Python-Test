...
def update_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',
                         ...
                         title='Correlation between Payload vs. Success for All Sites')
    else:
...
#Which payload range(s) has the highest launch success rate? 2k-5,5k
#Which payload range(s) has the lowest launch success rate? 2k-7k
